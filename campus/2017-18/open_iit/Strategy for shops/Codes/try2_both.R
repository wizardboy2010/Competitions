...
df$Sale_pop = df$Sale/df$Population
#functions needed
...
for(i in levels(df$Category.of.SKU)){
  ...
  l[[c]]=dummy.data.frame(e[[c]][,1:10],sep = ",")
  l[[c]]=scale(l[[c]])
...
ncol(l[[3]])
for(i in 1:nrow(l[[3]])){
  if(e[[3]][i,4]<=median(e[[3]]$Sale,na.rm = TRUE)){
    e[[3]][i,10]=1
  }
  if(e[[3]][i,4]>median(e[[3]]$Sale,na.rm = TRUE)){
    e[[3]][i,10]=2
...
ncol(l[[4]])
for(i in 1:nrow(l[[4]])){
  if(e[[4]][i,4]<=median(e[[4]]$Sale,na.rm = TRUE)){
    e[[4]][i,10]=1
  }
  if(e[[4]][i,4]>median(e[[4]]$Sale,na.rm = TRUE)){
    e[[4]][i,10]=2
...
ncol(l[[5]])
for(i in 1:nrow(l[[5]])){
  if(e[[5]][i,4]<=median(e[[5]]$Sale,na.rm = TRUE)){
    e[[5]][i,10]=1
  }
  if(e[[5]][i,4]>median(e[[5]]$Sale,na.rm = TRUE)){
    e[[5]][i,10]=2
...
ncol(l[[6]])
for(i in 1:nrow(l[[6]])){
  if(e[[6]][i,4]<=median(e[[6]]$Sale,na.rm = TRUE)){
    e[[6]][i,10]=1
  }
  if(e[[6]][i,4]>median(e[[6]]$Sale,na.rm = TRUE)){
    e[[6]][i,10]=2
...
ncol(l[[7]])
for(i in 1:nrow(l[[7]])){
  if(e[[7]][i,4]<=median(e[[7]]$Sale,na.rm = TRUE)){
    e[[7]][i,10]=1
  }
  if(e[[7]][i,4]>median(e[[7]]$Sale,na.rm = TRUE)){
    e[[7]][i,10]=2
...
ncol(l[[8]])
for(i in 1:nrow(l[[8]])){
  if(e[[8]][i,4]<=median(e[[8]]$Sale,na.rm = TRUE)){
    e[[8]][i,10]=1
  }
  if(e[[8]][i,4]>median(e[[8]]$Sale,na.rm = TRUE)){
    e[[8]][i,10]=2
...
ncol(l[[9]])
for(i in 1:nrow(l[[9]])){
  if(e[[9]][i,4]<=median(e[[9]]$Sale,na.rm = TRUE)){
    e[[9]][i,10]=1
  }
  if(e[[9]][i,4]>median(e[[9]]$Sale,na.rm = TRUE)){
    e[[9]][i,10]=2
...
for(i in 1:nrow(l[[10]])){
  if(e[[10]][i,4]<=median(e[[10]]$Sale,na.rm = TRUE)){
    e[[10]][i,10]=1
  }
  if(e[[10]][i,4]>median(e[[10]]$Sale,na.rm = TRUE)){
    e[[10]][i,10]=2
...
for(i in 1:nrow(l[[11]])){
  if(e[[11]][i,4]<=median(e[[11]]$Sale,na.rm = TRUE)){
    e[[11]][i,10]=1
  }
  if(e[[11]][i,4]>median(e[[11]]$Sale,na.rm = TRUE)){
    e[[11]][i,10]=2
...
for(i in 1:nrow(l[[12]])){
  if(e[[12]][i,4]<=median(e[[12]]$Sale,na.rm = TRUE)){
    e[[12]][i,10]=1
  }
  if(e[[12]][i,4]>median(e[[12]]$Sale,na.rm = TRUE)){
    e[[12]][i,10]=2
...
for(i in 1:nrow(l[[13]])){
  if(e[[13]][i,4]<=median(e[[13]]$Sale,na.rm = TRUE)){
    e[[13]][i,10]=1
  }
  if(e[[13]][i,4]>median(e[[13]]$Sale,na.rm = TRUE)){
    e[[13]][i,10]=2
...
for(i in 1:nrow(l[[14]])){
  if(e[[14]][i,4]<=median(e[[14]]$Sale,na.rm = TRUE)){
    e[[14]][i,10]=1
  }
  if(e[[14]][i,4]>median(e[[14]]$Sale,na.rm = TRUE)){
    e[[14]][i,10]=2
...
for(i in 1:nrow(l[[15]])){
  if(e[[15]][i,4]<=median(e[[15]]$Sale,na.rm = TRUE)){
    e[[15]][i,10]=1
  }
  if(e[[15]][i,4]>median(e[[15]]$Sale,na.rm = TRUE)){
    e[[15]][i,10]=2
...
for(i in 1:nrow(l[[16]])){
  if(e[[16]][i,4]<=median(e[[16]]$Sale,na.rm = TRUE)){
    e[[16]][i,10]=1
  }
  if(e[[16]][i,4]>median(e[[16]]$Sale,na.rm = TRUE)){
    e[[16]][i,10]=2
...
for(i in 1:nrow(l[[17]])){
  if(e[[17]][i,4]<=median(e[[17]]$Sale,na.rm = TRUE)){
    e[[17]][i,10]=1
  }
  if(e[[17]][i,4]>median(e[[17]]$Sale,na.rm = TRUE)){
    e[[17]][i,10]=2
...
for(i in 1:nrow(l[[18]])){
  if(e[[18]][i,4]<=median(e[[18]]$Sale,na.rm = TRUE)){
    e[[18]][i,10]=1
  }
  if(e[[18]][i,4]>median(e[[18]]$Sale,na.rm = TRUE)){
    e[[18]][i,10]=2
...
for(i in 1:nrow(l[[19]])){
  if(e[[19]][i,4]<=median(e[[19]]$Sale,na.rm = TRUE)){
    e[[19]][i,10]=1
  }
  if(e[[19]][i,4]>median(e[[19]]$Sale,na.rm = TRUE)){
    e[[19]][i,10]=2
