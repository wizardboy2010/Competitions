...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[1]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[1]][,j],k$cluster))
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[2]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[2]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[3]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[3]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[4]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[4]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[5]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[5]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[6]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[6]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[7]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[7]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[8]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[8]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[9]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[9]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
#health
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[10]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[10]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[11]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[11]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[12]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[12]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[13]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[13]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[14]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[14]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[15]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[15]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[16]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[16]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[17]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[17]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[18]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[18]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
...
for(i in 1:100){
  ...
  temp_acc = c(temp_acc, acc(e[[19]][,j],k$cluster))
  acctemp = max(temp_acc)
  if (acctemp == acc(e[[19]][,j],k$cluster)){temp_clust = list(k$cluster)}
}
accuracy = append(accuracy, acctemp)
clust = append(clust, temp_clust)
